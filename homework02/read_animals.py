...
#bizarre_animals['animals'].append( {'head': new_animal_head, 'body': new_animal_body, 'arms': new_animal_arms, 'legs': new_animal_legs, 'tails': new_animal_tails, 'parent': parent1, 'parent': parent2} )
...
def main():
    ...
    parent1 = animals['animals'][parent1_index]
    parent1_head = animals['animals'][parent1_index]['head']
    parent1_body = animals['animals'][parent1_index]['body']
    parent1_arms = animals['animals'][parent1_index]['arms']
    parent1_legs = animals['animals'][parent1_index]['legs']
    parent1_tails = animals['animals'][parent1_index]['tails']

    parent2_index = random.randint(0,19)

    parent2 = animals['animals'][parent2_index]
    parent2_head = animals['animals'][parent1_index]['head']
    parent2_body = animals['animals'][parent1_index]['body']
    parent2_arms = animals['animals'][parent1_index]['arms']
    parent2_legs = animals['animals'][parent1_index]['legs']
    parent2_tails = animals['animals'][parent1_index]['tails']
    ...
    animals['animals'].append( {'head': new_animal_head, 'body': new_animal_body, 'arms': new_animal_arms, 'legs': new_animal_legs, 'tails': new_animal_tails, '1st parent': parent1, '2nd parent': parent2} )
